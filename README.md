About llama-index-workflows-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llama-index-workflows-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llama-index-workflows-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add llama-index-workflows
# for installing globally
pixi global install llama-index-workflows
```
...
It is possible to list all of the versions of `llama-index-workflows` available on your platform:
...
```
pixi search llama-index-workflows --channel conda-forge
```
